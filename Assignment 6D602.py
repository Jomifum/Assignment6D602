...
def exercise02():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df2 = pd.read_csv("https://raw.githubusercontent.com/Jomifum/Assignment6D602/main/data.csv")
    print(df2.head())
    # ------ Place code above here /\ /\ /\ ------
    return df2
...
def exercise04():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    data = [{'city': 'New York', 'data': 100},
            {'city': 'Los Angeles', 'data': 200},
            {'city': 'Chicago', 'data': 300}]
...
def exercise06():
    ...
    Assume the Excel file has columns 'id', 'name', 'value'. Return the DataFrame.
    '''
    # ------ Place code below here \/ \/ \/ ------
    df6 = pd.read_excel("https://raw.githubusercontent.com/Jomifum/Assignment6D602/main/data.xlsx", engine='openpyxl')
    print(df6.columns)  # Print columns to verify
    # ------ Place code above here /\ /\ /\ ------
    return df6
